...
#ifndef NDT__OMP_MULTI_VOXEL_HPP_
#define NDT__OMP_MULTI_VOXEL_HPP_
...
class NormalDistributionsTransformOMPMultiVoxel
: public NormalDistributionsTransformBase<PointSource, PointTarget>
{
public:
  struct OMPMultiVoxelParam
  {
    int num_threads;
  };
  ...
  NormalDistributionsTransformOMPMultiVoxel(
    const NormalDistributionsTransformOMPMultiVoxel &obj);
  ...
  OMPMultiVoxelParam getOMPMultiVoxelParam();
...
#include "ndt/impl/omp_multi_voxel.hpp"

#endif  // NDT__OMP_MULTI_VOXEL_HPP_
