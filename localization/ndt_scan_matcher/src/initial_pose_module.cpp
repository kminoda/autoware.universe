  ...
  key_value_stdmap_ptr_(key_value_stdmap_ptr)
{
  ...
  service_ = node->create_service<tier4_localization_msgs::srv::PoseWithCovarianceStamped>(
    "ndt_align_srv",
    std::bind(
      &InitialPoseModule::service_ndt_align, this, std::placeholders::_1, std::placeholders::_2),
    rclcpp::ServicesQoS().get_rmw_qos_profile(), main_callback_group);
}

void InitialPoseModule::service_ndt_align(
...
geometry_msgs::msg::PoseWithCovarianceStamped InitialPoseModule::align_using_monte_carlo(
...
void InitialPoseModule::publish_point_cloud(
