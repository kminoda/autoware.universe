  ...
  regularization_scale_factor_(declare_parameter("regularization_scale_factor", 0.01))
{
  ...
  ndt_params_ = get_default_ndt_params(this, ndt_ptr_);
  set_ndt_params(ndt_ptr_, ndt_params_, ndt_implement_type_);
...
{
  auto new_ndt_ptr = get_ndt<PointSource, PointTarget>(ndt_implement_type_);
  set_ndt_params(new_ndt_ptr, ndt_params_, ndt_implement_type_);
